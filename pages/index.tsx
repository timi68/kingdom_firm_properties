					...
					<div className="card-content">
						<div className="text">
							...
							<div className="secondary-text">
								Everything will do is always transparent to our
								client, your deal is save as update on process
								of your dream home. We always want premium
			...
			<div className="paper explore">
				<div className="paper-card-wrapper explore-wrapper">
					...
					<div className="card-content">
						<div className="text">
							<div className="primary-text">
								ARE YOU A STUDENT LOOKING FOR HOSTEL CLOSE TO
								YOUR SCHOOL
							</div>
							<div className="secondary-text">
								TRY EXPLORE YOU CAN GET ONE
							</div>
						</div>
						<Button
							variant="contained"
			...
			<section className="know-about neighbourhoods">
				<div className="know-about-wrapper">
					<div className="section-header">
						<div className="primary-text">
							<div className="text">
								Know about neightbourhoods on KFP
							</div>
						</div>
						<div className="secondary-text desciption brief-about-r">
							<div className="text">
								KFP gives you everyday insight and reviews of a
								neighbourhood so you can decide if a home and
							...
							<Card className="card about-card" elevation={10}>
								<CardActionArea className="card-action-area">
									<CardContent>
										...
										<div className="text">
											Lekki Phase 1 is a well planned and
											mapped-out residential scheme...
										</div>
									</CardContent>
								</CardActionArea>
							</Card>
			...
			<div className="paper management">
				<div className="paper-card-wrapper management-wrapper">
					...
					<div className="card-content">
						<div className="text">
							<div className="primary-text">
								WE ARE REAL ESTATE MANAGEMENT
							</div>
							<div className="secondary-text">
								Want to be part of our agent community, you just
								need a click
							</div>
						</div>
						<Button
